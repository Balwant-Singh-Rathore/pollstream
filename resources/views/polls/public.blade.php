        ...
        <div class="relative z-10 w-full max-w-xl">
                ...
                <div class="px-7 pb-5 pt-7">
                    ...
                    <div class="mt-3 flex items-center gap-4 text-white/50 text-xs">
                        <div class="flex items-center gap-1.5 text-white/40">
                            ...
                            <span class="text-xs font-medium text-white/40" id="totalVotes">
                                {{ $poll->total_votes }} total votes
                            </span>
                            <span id="plusOneAnimation"
                                class="right-0 -top-2 text-green-400 text-xs font-bold opacity-0 pointer-events-none">
                                +1
                            </span>
                        </div>
                        <div class="flex items-center gap-1.5 text-white/40">
                            ...
                            <form method="POST" action="{{ route('public.poll.vote', $poll->id) }}">
                                ...
                                <div class="space-y-3">
                                    @foreach ($poll->options as $option)
                                        <label
                                            class="flex cursor-pointer items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-4 hover:bg-white/10">
            ...
            <div class="mt-10 flex flex-col items-center text-center">
                ...
                <a href="#" class="group flex items-center gap-3 rounded-xl px-4 py-2 transition">
                    ...
                    <span
                        class="text-lg font-semibold tracking-wide text-white transition group-hover:text-indigo-400">
                        Pollstream
                    </span>
                </a>
            </div>
