...
<body
    class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex lg:justify-center min-h-screen flex-col">
    <div class="relative flex min-h-screen items-center justify-center px-4 py-12 bg-cover bg-center">
        <div class="relative z-10 w-full max-w-xl">
            <div class="mb-5 flex items-center justify-center gap-3">
                <div
                    class="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 backdrop-blur-md">
            ...
            <div class="overflow-hidden rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl">
                ...
                <div class="px-7 pb-5 pt-7">
                    ...
                    <h1 class="text-xl font-bold leading-snug text-white">
                        {{ $poll->question }}
                    </h1>

                    <div class="mt-3 flex items-center gap-4 text-white/50 text-xs">
                ...
                <div class="px-7 py-6">
                    @if(!session('voted') && !$alreadyVoted)
                        <div class="space-y-3">
                            <p class="mb-4 text-sm font-medium text-white/50">
                                Choose your answer
                            </p>
                            <form method="POST" action="{{ route('public.poll.vote', $poll->id) }}">
                                ...
                                <div class="space-y-3">
                                    @foreach ($poll->options as $option)
                                        <label class="flex cursor-pointer items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-4 hover:bg-white/10">
                                        <input
                                            type="radio"
                                            name="option_id"
                                            value="{{ $option->id }}"
                    ...
                    @if(session('voted') || $alreadyVoted)
                        <div class="space-y-3">
                            <div class="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/15 px-2.5 py-1 border border-emerald-400/20">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                         ...
                         <div class="mb-4 flex items-center justify-between">
                            ...
                            @foreach ($poll->options->sortByDesc('votes_count') as $option)
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 h-2.5 w-full bg-white/10 rounded-full">
                                        <div
                                            class="h-full rounded-full bg-gradient-to-r from-purple-500 to-blue-500"
                                            style="width: {{ $percentage }}%">
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-1.5 text-white/40 mt-2">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            width="24" height="24"
                                            viewBox="0 0 24 24"
                                            fill="none"
            ...
            <div class="mt-10 flex flex-col items-center text-center">
                ...
                <a href="#" class="group flex items-center gap-3 rounded-xl px-4 py-2 transition">
                    <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-indigo-500 shadow-md shadow-indigo-500/30 transition group-hover:scale-105">
                        <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                        </svg>
                    </div>
                    <span class="text-lg font-semibold tracking-wide text-white transition group-hover:text-indigo-400">
                        Pollstream
                    </span>
                </a>
            </div>
